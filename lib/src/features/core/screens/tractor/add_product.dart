...
import 'package:tractor_hiring_app/src/features/core/screens/tractor/product_controller.dart';
...
class _addProductPageState extends State<addProductPage> {
  ...
  uploadDataToFirebase() async {
    ...
    FilePickerResult? result = await FilePicker.platform.pickFiles(
      type: FileType.image,
      allowMultiple: true,
      dialogTitle: "Select Tractor Images",
    );
  ...
  Widget build(BuildContext context) {
    final controller2 = Get.put(TractorController());
                ...
                ListView(
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: Text(
                        "Fill In below to add a new Tractor",
                        maxLines: 2,
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Add Tractor Name',
                      ),
                      validator: (value) {
                        if (value!.trim().isEmpty) {
                          return 'Please enter the tractor name';
                        }
                        return null;
                      },
                    ),
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value!.isEmpty) {
                          return 'Please enter the tractor details';
                        }
                        return null;
                      },
                    ),
...
//_productSpeedController
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              decoration: const InputDecoration(
                                labelText: 'Tractor Speed Km/hr',
                              ),
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return 'Please provide Tractor Speed Km/hr';
                                }
                                return null;
                              },
                            ),
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              labelText: 'Tractor Engine Capacity',
                            ),
                            validator: (value) {
                              if (value!.isEmpty) {
                                return 'Please provide  Tractor Engine Capacity';
                              }
                              return null;
                            },
                          ),
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              labelText: 'Tractor Fuel Consumption',
                            ),
                            validator: (value) {
                              if (value!.isEmpty) {
                                return 'Please provide  Tractor Fuel Consumption';
                              }
                              return null;
                            },
                          ),
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                              labelText: 'Tractor Horse Power',
                            ),
                            validator: (value) {
                              if (value!.isEmpty) {
                                return 'Please provide  Tractor Power';
                              }
                              return null;
                            },
                          ),
                    ...
                    const Center(
                      ...
                      child: Text("Select Tractor Category"),
                    )),
                    Center(
                    ...
                    const Center(
                      child: Padding(
                        padding: EdgeInsets.all(8.0),
                        child: Text(
                          'Please Upload Tractor Images (max 4 images)',
                        ),
                      ),
                    ),
                    ElevatedButton(
                          ...
                          : () {
                              if (urls.isEmpty || urls.isEmpty) {
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(const SnackBar(
                                  content: Text(
                                      "Please upload at least one tractor Image"),
                                ));
                                return;
                              } else {
