...
class _OnBoardState extends State<OnBoard> {
  ...
  List<OnboardModel> screens = <OnboardModel>[
    OnboardModel(
      ...
      text: "Welcome to Gerald Tractor Hiring App",
      desc:
          "We are proud to offer a range of top quality Tractors for hire",
      bg: Colors.white,
      button: const Color(0xFF4756DF),
    ),
    OnboardModel(
      img: 'assets/images/img-2.png',
      text: "Exceptional power machines",
      desc: "These tractors are known for their exceptional engine power perfomance..",
    ...
    OnboardModel(
      ...
      text: "Afordability",
      desc: "You can tacle any task with ease with our tractors at affordable prices..",
      bg: Colors.white,
      button: const Color(0xFF4756DF),
    ),
  ];
